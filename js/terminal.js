...
const base = `binzh@<span style="color: #33D7FF">infocuatui.online</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
function updateConsole() {
    document.querySelector(".new-line")
        .innerHTML = sw ? index === 0 ? base + input + "|" : base + input.slice(0, index) + "|" + input.slice(index) : base + input
}
...
function inputLine(k) {
    terminal.innerHTML += `\n<div class=\"new-line\">hoangbinh@<span style=\"color: #33D7FF\">infocuatui.online</span>:<span style=\"color: dodgerblue\">~</span>$ ${k?k:""}</div>`
}
...
function info() {
    terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>hoangbinh</span>@<span>infocuatui.online</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>Name</span>: Hoang Dinh Thanh Binh</div>\n" + "  <div><span>Ages</span>: 17</div>\n" + "  <div><span>Facebook</span>: <a href=\"https://facebook.com/khongphaihdtb\" target='_blank'>@khongphaihdtb</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com\" target='_blank'>binzh#8586</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UC6I9GMzcsDopa2g8OyXxmMg\" target='_blank'>Hoang Dinh Thanh Binh</a></div>\n" + "  <div><span>Github</span>: <a href=\"https://github.com/hoangdinhthanhbinh\" target='_blank'>Hoàng Đình Thanh Bình</a></div>\n" + "  <div><span>osu!</span>: <a href=\"https://osu.ppy.sh/users/2\" target='_blank'>- lol -</a></div>\n" + "  <div><span>Tifality</span>: <a href=\"https://tifality.club\" target='_blank'>Download now!</a></div>\n" + '  <div style="padding-bottom:10px; clear: both;">'
}
